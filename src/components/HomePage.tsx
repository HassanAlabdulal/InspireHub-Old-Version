  ...
  return (
    <main className="flex flex-col items-center justify-center w-full gap-3 mt-36 max-md:mt-30">
      <div className="flex flex-col items-center justify-center">
        <h1
          className="max-w-6xl text-6xl font-extrabold tracking-tight leading-none text-center max-xl:text-5xl max-xl:max-w-5xl
         max-md:text-4xl max-md:max-w-4xl max-sm:text-2xl max-sm:max-w-2xl  mb-8 text-[#8a3d57] font-nunito"
        >
          <span className="">InspireHub:</span>
          Where Ideas Take Flight and Creativity Meets Opportunity!
        </h1>

        <p className="mb-8 text-2xl font-normal text-center text-gray-300 font-roboto lg:text-xl max-sm:text-xl max-sm:max-w-sm sm:px-16 lg:px-48">
