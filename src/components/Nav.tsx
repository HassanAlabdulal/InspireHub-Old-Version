...
export default function Nav() {
  ...
  return (
    <nav className=" fixed w-full top-0 bg-green-300 flex items-center justify-between mb-24 pb-8 pt-8 px-16 max-md:px-8 font-medium shadow-md md:ml-0 lg:ml-0 ">
